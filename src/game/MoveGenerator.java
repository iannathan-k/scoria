...
public class MoveGenerator {
    ...
    public static boolean isUnderAttack(int pos, int victim_color) {
        int enemy_offset = victim_color ^ 1;
    ...
    public static boolean doesMoveCauseCheck(int move, int color) {
        ...
        int pos = Long.numberOfTrailingZeros(BitBoard.piece_bitboards[BitBoard.WHITE_KING + color]);
    ...
    // FIXME: Consider psuedo legality
    public static MoveList generateAllMoves(int color) {
        ...
        while (double_push != 0L) {
            ...
            int move = encodeMove(origin, target, BitBoard.WHITE_PAWN + color, MoveHandler.DOUBLE_FLAG);
            if (!doesMoveCauseCheck(move, color)) {
                move_list.add(move);
            }
        ...
        while (knight_board != 0L) {
            ...
            while (moves != 0L) {
                ...
                int move = encodeMove(square, target, BitBoard.WHITE_KNIGHT + color);
                if (!doesMoveCauseCheck(move, color)) {
                    move_list.add(move);
                }
        ...
        while (king_board != 0L) {
            ...
            while (moves != 0L) {
                ...
                int move = encodeMove(square, target, BitBoard.WHITE_KING + color);
                if (!doesMoveCauseCheck(move, color)) {
                    move_list.add(move);
                }
        ...
        while (bishop_board != 0L) {
            ...
            while (moves != 0L) {
                ...
                int move = encodeMove(square, target, BitBoard.WHITE_BISHOP + color);
                if (!doesMoveCauseCheck(move, color)) {
                    move_list.add(move);
                }
        ...
        while (rook_board != 0L) {
            ...
            while (moves != 0L) {
                ...
                int move = encodeMove(square, target, BitBoard.WHITE_ROOK + color);
                if (!doesMoveCauseCheck(move, color)) {
                    move_list.add(move);
                }
        ...
        while (queen_board != 0L) {
            ...
            while (moves != 0L) {
                ...
                int move = encodeMove(square, target, BitBoard.WHITE_QUEEN + color);
                if (!doesMoveCauseCheck(move, color)) {
                    move_list.add(move);
                }
